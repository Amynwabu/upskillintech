...
const FEATURED = [
  {
    icon: <BookOpen size={28} style={{ color: "#2E7B20" }} />,
    badge: "Free Guide",
  ...
  {
    icon: <FileText size={28} style={{ color: "#50B040" }} />,
    badge: "Download",
  ...
  {
    icon: <Zap size={28} style={{ color: "#50B040" }} />,
    badge: "Playbook",
...
const CASE_STUDIES = [
  { icon: <Briefcase size={22} style={{ color: "#2E7B20" }} />, title: "Professional Use Cases", desc: "Examples of individuals integrating AI into their daily work — from consultants to educators.", href: "/resources/case-studies" },
  { icon: <Users size={22} style={{ color: "#50B040" }} />, title: "Organisational AI Adoption", desc: "How teams implement AI productivity systems and transform internal processes.", href: "/resources/case-studies" },
  { icon: <Star size={22} style={{ color: "#D1A81D" }} />, title: "Ministry AI Applications", desc: "Using AI to support teaching, communication, and administration in faith communities.", href: "/resources/case-studies" },
];
...
export default function Resources() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      >
        <div className="absolute top-[-80px] right-[-80px] rounded-full pointer-events-none" style={{ width: 400, height: 400, background: "rgba(209,168,29,0.10)" }} />
        <div className="container relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center py-20 lg:py-28">
            <div>
              <span className="inline-block text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full mb-4" style={{ background: "rgba(46,123,32,0.10)", color: "#F3F4F6", border: "1px solid rgba(255,255,255,0.35)" }}>Resource Hub</span>
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/resources/ai-guides" className="inline-flex items-center gap-2 font-semibold px-6 py-3 rounded-lg transition-all" style={{ background: "#151B23", color: "#2E7B20", fontFamily: "'Sora', sans-serif" }}>
            ...
            <div className="hidden lg:grid grid-cols-2 gap-4 max-w-sm w-full ml-auto">
              {[
                { icon: <BookOpen size={28} style={{ color: "#2E7B20" }} />, label: "AI Guides", count: "12+" },
                { icon: <FileText size={28} style={{ color: "#50B040" }} />, label: "Blog Articles", count: "40+" },
                { icon: <Play size={28} style={{ color: "#D1A81D" }} />, label: "Webinars", count: "20+" },
                { icon: <Zap size={28} style={{ color: "#2E7B20" }} />, label: "Workflows", count: "15+" },
              ].map((item) => (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {BLOG_CATEGORIES.map((cat) => (
              <Link key={cat.title} href={cat.href} className="group rounded-xl p-6 flex items-start gap-4 transition-all hover:-translate-y-1" style={{ background: "#151B23", border: "1px solid #1F2937", boxShadow: "0 2px 12px rgba(0,0,0,0.04)" }}>
                <div className="rounded-xl p-3 shrink-0" style={{ background: "#10231C", color: "#2E7B20" }}>{cat.icon}</div>
                <div>
                  ...
                  <span className="inline-flex items-center gap-1 text-xs font-semibold mt-3" style={{ color: "#2E7B20" }}>View Articles <ChevronRight size={14} /></span>
                </div>
              </Link>
            ))}
            <Link href="/resources/blog" className="rounded-xl p-6 flex flex-col items-center justify-center text-center transition-all hover:-translate-y-1" style={{ background: "linear-gradient(135deg, #2E7B20, #50B040)", boxShadow: "0 4px 20px rgba(46,123,32,0.25)" }}>
                ...
                {AI_GUIDES.map((g) => (
                  <div key={g.title} className="flex items-start gap-4 rounded-xl p-5" style={{ background: "#151B23", border: "1px solid #1F2937" }}>
                    <div className="rounded-lg p-2 shrink-0" style={{ background: "#10231C" }}>
                      <BookOpen size={20} style={{ color: "#2E7B20" }} />
                    </div>
                    ...
                    <Link href={g.href} className="shrink-0 text-sm font-semibold flex items-center gap-1" style={{ color: "#2E7B20" }}>
                      {g.cta} <ChevronRight size={14} />
                    </Link>
                  </div>
                ))}
              </div>
              <Link href="/resources/ai-guides" className="inline-flex items-center gap-2 mt-8 font-semibold px-6 py-3 rounded-lg" style={{ background: "#2E7B20", color: "#fff", fontFamily: "'Sora', sans-serif" }}>
                <Download size={18} /> Browse All Guides
              </Link>
            </div>
            {/* Email capture */}
            <div className="rounded-2xl p-8" style={{ background: "linear-gradient(135deg, #50B040 0%, #D1A81D 100%)", boxShadow: "0 16px 48px rgba(139,158,26,0.25)" }}>
              ...
              <form onSubmit={handleDownload} className="flex flex-col gap-3">
                ...
                <button type="submit" className="w-full font-bold py-3 rounded-lg transition-all" style={{ background: "#1C1C1C", color: "#D1A81D", fontFamily: "'Sora', sans-serif" }}>
                  Download Free Guide
                </button>
              </form>
      ...
      <section className="section-py" style={{ background: "#1C1C1C" }}>
        <div className="container">
          <div className="text-center mb-12">
            <span className="inline-block text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full mb-3" style={{ background: "rgba(209,168,29,0.15)", color: "#D1A81D" }}>Real Impact</span>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {CASE_STUDIES.map((cs) => (
              <Link key={cs.title} href={cs.href} className="group rounded-2xl p-7 flex flex-col transition-all hover:-translate-y-1" style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.10)" }}>
                ...
                <span className="inline-flex items-center gap-1 text-sm font-semibold mt-5" style={{ color: "#D1A81D" }}>View Case Studies <ChevronRight size={14} /></span>
              </Link>
            ))}
          </div>
          <div className="text-center mt-10">
            <Link href="/resources/case-studies" className="inline-flex items-center gap-2 font-semibold px-6 py-3 rounded-lg" style={{ background: "#D1A81D", color: "#F3F4F6", fontFamily: "'Sora', sans-serif" }}>
      ...
      <section className="section-py" style={{ background: "#151B23" }}>
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-10">
            {WEBINARS.map((w) => (
              <div key={w.title} className="rounded-xl overflow-hidden" style={{ background: "#151B23", border: "1px solid #1F2937", boxShadow: "0 2px 12px rgba(0,0,0,0.05)" }}>
                <div className="h-2" style={{ background: w.type === "Upcoming" ? "#D1A81D" : "#2E7B20" }} />
                <div className="p-6">
                  ...
                  <Link href={w.href} className="inline-flex items-center gap-2 text-sm font-semibold" style={{ color: w.type === "Upcoming" ? "#8B6914" : "#2E7B20" }}>
          ...
          <div className="text-center">
            <Link href="/resources/webinars" className="inline-flex items-center gap-2 font-semibold px-6 py-3 rounded-lg" style={{ background: "#2E7B20", color: "#fff", fontFamily: "'Sora', sans-serif" }}>
      ...
      <section className="section-py" style={{ background: "#151B23" }}>
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {WORKFLOWS.map((wf) => (
              <Link key={wf.title} href={wf.href} className="group rounded-xl p-6 transition-all hover:-translate-y-1" style={{ background: "#151B23", border: "1px solid #1F2937" }}>
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  {wf.steps.map((step, si) => (
                    <div key={step} className="flex items-center gap-2">
                      ...
                      {si < wf.steps.length - 1 && <span style={{ color: "#D1A81D", fontWeight: 700 }}>→</span>}
                    </div>
                  ))}
                </div>
                <span className="inline-flex items-center gap-1 text-sm font-semibold mt-4" style={{ color: "#2E7B20" }}>Explore Workflow <ChevronRight size={14} /></span>
              </Link>
            ))}
          </div>
          <div className="text-center mt-10">
            <Link href="/resources/workflows" className="inline-flex items-center gap-2 font-semibold px-6 py-3 rounded-lg" style={{ background: "#2E7B20", color: "#fff", fontFamily: "'Sora', sans-serif" }}>
      ...
      {/* ── 8. SEARCH ── */}
      <section className="section-py" style={{ background: "#10231C" }}>
        <div className="container max-w-2xl mx-auto text-center">
          ...
          <form onSubmit={handleSearch} className="flex gap-3 mb-6">
            <input
              ...
              style={{ border: "2px solid #2E7B20", fontFamily: "'DM Sans', sans-serif" }}
            />
            <button type="submit" className="flex items-center gap-2 font-semibold px-5 py-3 rounded-lg" style={{ background: "#2E7B20", color: "#fff" }}>
              <Search size={18} />
            </button>
          </form>
          <div className="flex flex-wrap gap-2 justify-center">
            ...
            {POPULAR_TOPICS.map(t => (
              <button key={t} onClick={() => { setSearchQuery(t); toast.success(`Searching "${t}"…`); }} className="text-sm px-3 py-1 rounded-full transition-all hover:bg-green-100" style={{ background: "#151B23", border: "1px solid #2E7B20", color: "#2E7B20" }}>
                {t}
              </button>
            ))}
          </div>
      ...
      <section className="section-py" style={{ background: "#1C1C1C" }}>
        <div className="container">
          <div className="max-w-3xl mx-auto rounded-2xl p-10 text-center" style={{ background: "linear-gradient(135deg, #2E7B20 0%, #50B040 60%, #D1A81D 100%)" }}>
            ...
            <form onSubmit={handleDownload} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              ...
              <button type="submit" className="font-bold px-6 py-3 rounded-lg whitespace-nowrap" style={{ background: "#1C1C1C", color: "#D1A81D", fontFamily: "'Sora', sans-serif" }}>
                Download Free Guide
              </button>
            </form>
      ...
      <section className="section-py" style={{ background: "#151B23" }}>
        <div className="container text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/#programs" className="inline-flex items-center gap-2 font-semibold px-7 py-3 rounded-lg" style={{ background: "#2E7B20", color: "#fff", fontFamily: "'Sora', sans-serif" }}>
              <ArrowRight size={18} /> Explore Programs
            </Link>
            <Link href="/#community" className="inline-flex items-center gap-2 font-semibold px-7 py-3 rounded-lg border-2" style={{ borderColor: "#2E7B20", color: "#2E7B20", fontFamily: "'Sora', sans-serif" }}>
