 ...
 * URL: /about
 * Design: Green (#439288) + Golden Green (#8B9E1A) + Yellow (#E6B800) + Dark (#1C1C1C)
...
const MISSION_PILLARS = [
  { icon: <BookOpen size={24} />, label: "Understand AI", desc: "Build foundational AI literacy for professionals at every level — from awareness to confident application.", color: "#439288" },
  ...
  { icon: <Target size={24} />, label: "Lead Responsibly", desc: "Equip leaders to guide their teams and organisations through AI adoption with clarity and confidence.", color: "#439288" },
];

const FOUNDER_EXPERTISE = [
  { icon: <Brain size={22} />, label: "AI Expertise", desc: "Research and development in artificial intelligence and machine learning systems, with a focus on practical applications in professional environments.", color: "#439288" },
  ...
  { icon: <Handshake size={22} />, label: "Industry Collaboration", desc: "Collaboration with organisations and research partners to develop practical AI applications that create measurable impact.", color: "#439288" },
];
...
const ECOSYSTEM_STAGES = [
  { step: "01", label: "Awareness", desc: "Articles, videos, and insights on AI — building foundational understanding of what AI is and how it applies to real work.", icon: <BookOpen size={28} />, color: "#439288" },
  ...
  { step: "04", label: "Community", desc: "A network of professionals and leaders exploring AI together — sharing wins, workflows, and accountability.", icon: <Users size={28} />, color: "#439288" },
];
    ...
    <div className="min-h-screen flex flex-col" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <section className="relative overflow-hidden pt-16" style={{ background: "linear-gradient(135deg, #10231C 0%, #11161A 40%, #1A1606 100%)" }}>
        ...
        <div className="container relative z-10 py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="inline-block text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full mb-5" style={{ background: "rgba(67,146,136,0.10)", color: "#F3F4F6", border: "1px solid rgba(255,255,255,0.35)" }}>About UpskillinTech</span>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link href="/#community" className="font-bold px-6 py-3 rounded-lg flex items-center gap-2 text-sm" style={{ background: "rgba(67,146,136,0.10)", color: "#F3F4F6", border: "1.5px solid rgba(255,255,255,0.40)", fontFamily: "'Sora', sans-serif", textDecoration: "none" }}>
            ...
            <div className="hidden lg:flex items-center justify-center">
              <div className="relative w-80 h-80">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-28 h-28 rounded-full flex flex-col items-center justify-center text-center" style={{ background: "rgba(67,146,136,0.10)", border: "2px solid rgba(255,255,255,0.40)" }}>
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-start">
            ...
            <div className="flex flex-col items-center lg:items-start">
              <div className="relative mb-6">
                <div className="w-52 h-52 rounded-2xl overflow-hidden" style={{ border: "4px solid #439288" }}>
                  <img
                    ...
                    onError={(e) => {
                      ...
                      parent.style.background = "linear-gradient(135deg, #439288, #E6B800)";
              ...
              <p className="text-sm mb-4" style={{ color: "#439288", fontFamily: "'Sora', sans-serif" }}>Lecturer in AI | Robotics Researcher | Educator</p>
              <div className="flex flex-wrap gap-2">
                {["AI Research", "Robotics", "Education", "Industry Collaboration"].map(tag => (
                  <span key={tag} className="text-xs px-3 py-1 rounded-full" style={{ background: "#43928812", color: "#439288", border: "1px solid #43928825" }}>{tag}</span>
                ))}
              </div>
            </div>
      ...
      <section className="section-py" style={{ background: "#1C1C1C" }}>
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="inline-block text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full mb-4" style={{ background: "rgba(67,146,136,0.15)", color: "#439288", border: "1px solid rgba(67,146,136,0.25)" }}>Our Vision</span>
            ...
            <div className="space-y-5">
              {VISION_POINTS.map((v, i) => (
                <div key={v.label} className="flex gap-5 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center shrink-0" style={{ background: i === 0 ? "#43928820" : i === 1 ? "#8B9E1A20" : "#E6B80020", color: i === 0 ? "#439288" : i === 1 ? "#8B9E1A" : "#E6B800" }}>
                    {v.icon}
                  </div>
                  <div>
      ...
      <section className="section-py" style={{ background: "#151B23" }}>
        <div className="container">
            ...
            {ECOSYSTEM_STAGES.map((stage, i) => (
              <div key={stage.label} className="relative flex flex-col items-center text-center px-4">
                ...
                {i < ECOSYSTEM_STAGES.length - 1 && (
                  <div className="hidden md:block absolute top-10 left-1/2 w-full h-0.5 z-0" style={{ background: "linear-gradient(90deg, #439288, #E6B800)" }} />
                )}
          ...
          <div className="text-center mt-12">
            <Link href="/#programs" className="inline-flex items-center gap-2 font-bold px-6 py-3 rounded-lg text-sm" style={{ background: "#439288", color: "#fff", fontFamily: "'Sora', sans-serif", textDecoration: "none" }}>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <button
                ...
                style={{ background: "#439288", color: "#fff", fontFamily: "'Sora', sans-serif" }}
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              {PARTNERSHIP_TYPES.map((p) => (
                <div key={p.label} className="p-5 rounded-2xl bg-[#151B23]" style={{ border: "1px solid #1F2937", boxShadow: "0 2px 12px rgba(0,0,0,0.04)" }}>
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-3" style={{ background: "#43928812", color: "#439288" }}>{p.icon}</div>
                  <h4 className="font-bold text-sm mb-2" style={{ fontFamily: "'Sora', sans-serif", color: "#F3F4F6" }}>{p.label}</h4>
                  <p className="text-xs leading-relaxed" style={{ color: "#9CA3AF" }}>{p.desc}</p>
                </div>
              ))}
      ...
      <section className="section-py" style={{ background: "#1C1C1C" }}>
        <div className="container max-w-3xl mx-auto text-center">
          <span className="inline-block text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full mb-5" style={{ background: "rgba(67,146,136,0.15)", color: "#439288", border: "1px solid rgba(67,146,136,0.25)" }}>Join the Journey</span>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/#programs" className="font-bold px-8 py-4 rounded-lg flex items-center gap-2" style={{ background: "#439288", color: "#fff", fontFamily: "'Sora', sans-serif", textDecoration: "none" }}>
