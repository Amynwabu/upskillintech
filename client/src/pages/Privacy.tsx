      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        ...
        <div className="space-y-10" style={{ fontFamily: "'DM Sans', sans-serif", color: "#D1D5DB", lineHeight: 1.8 }}>
          ...
          <section>
            ...
            <p className="mt-3">To exercise these rights, please contact us at <a href="mailto:privacy@upskillintech.com" style={{ color: "#2E7B20" }}>privacy@upskillintech.com</a>.</p>
          </section>
          ...
          <section>
            ...
            <p>As a UK-based organisation, we have appointed a Data Protection Officer. Contact our DPO at <a href="mailto:dpo@upskillintech.com" style={{ color: "#2E7B20" }}>dpo@upskillintech.com</a>.</p>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 p-5 rounded-xl" style={{ background: "#151B23" }}>
              ...
              <p>Email: <a href="mailto:privacy@upskillintech.com" style={{ color: "#2E7B20" }}>privacy@upskillintech.com</a></p>
              <p>Website: upskillintech.com</p>
              <p className="mt-4"><strong>UK Information Commissioner's Office</strong></p>
              <p>Website: <a href="https://www.ico.org.uk" target="_blank" rel="noreferrer" style={{ color: "#2E7B20" }}>www.ico.org.uk</a></p>
