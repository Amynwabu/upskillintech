...
const ALL_EDITIONS = [
  ...
  { slug: "5-ai-workflows-that-save-professionals-10-hours-a-week", title: "5 AI Workflows That Save Professionals 10 Hours a Week", excerpt: "Practical, copy-paste AI workflows for meetings, research, content creation, email management, and client reporting — tested by real professionals.", date: "February 2026", readTime: "7 min read", tag: "Workflow Guide", tagColor: "#50B040" },
              ...
              <div className="flex flex-wrap gap-2">
                {TAGS.map((tag) => (
                  <button
                    ...
                    style={{
                      background: activeTag === tag ? "#2E7B20" : "#F3F4F6",
                      color: activeTag === tag ? "#fff" : "#374151",
                      border: activeTag === tag ? "1.5px solid #2E7B20" : "1.5px solid #1F2937",
                    }}
                  >
                    {tag}
                  </button>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                        ...
                        <div className="flex-shrink-0 flex items-center">
                          <span className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl font-semibold text-sm"
                            style={{ background: "rgba(46,123,32,0.1)", color: "#2E7B20" }}>
        ...
        <section style={{ background: "linear-gradient(135deg, #111827 0%, #1a2e1a 100%)", padding: "70px 0" }}>
          <div className="container">
            <div className="max-w-xl mx-auto text-center">
              <Mail size={40} className="mx-auto mb-5" style={{ color: "#2E7B20" }} />
              ...
              {subDone ? (
                <div className="flex items-center justify-center gap-3" style={{ color: "#2E7B20" }}>
                  <CheckCircle size={24} />
                ...
                <form onSubmit={(e) => { e.preventDefault(); if (email) subscribe.mutate({ email }); }}
                  ...
                  <button type="submit" disabled={subscribe.isPending}
                    ...
                    style={{ background: "linear-gradient(135deg, #2E7B20, #50B040)", whiteSpace: "nowrap" }}>
