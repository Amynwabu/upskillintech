...
export default function Events() {
  ...
  const events = [
    ...
    },
    {
      ...
      description: "A full-day intensive workshop where you will learn to build and deploy your own large language model application from scratch.",
    ...
    },
    {
      ...
      speakerTitle: "Founder, UpskillinTech | AI Researcher & Educator",
      ...
      <section className="pt-32 pb-12 border-b border-[#1F2937]" style={{ background: "linear-gradient(135deg, #f0fdfc 0%, #f7fef7 100%)" }}>
        <div className="container">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6" style={{ background: "rgba(46,204,113,0.10)", border: "1px solid rgba(46,204,113,0.25)" }}>
              <Calendar className="w-4 h-4" style={{ color: "#2ecc71" }} />
              <span className="text-sm font-semibold" style={{ fontFamily: "'Sora', sans-serif", color: "#2ecc71" }}>Events &amp; Workshops</span>
            </div>
            ...
            <div className="rounded-2xl p-6 md:p-8" style={{ background: "linear-gradient(135deg, rgba(46,204,113,0.08), rgba(46,204,113,0.08))", border: "1px solid rgba(46,204,113,0.20)" }}>
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div className="flex-1">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-white text-xs font-semibold mb-3" style={{ background: "#2ecc71" }}>
                ...
                <Link href="/resources/webinars">
                  <Button size="lg" className="font-semibold px-8" style={{ background: "#2ecc71", color: "white" }}>
                    Register Free
                  </Button>
                </Link>
              </div>
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-1">
            ...
            {eventTypes.map((type) => (
              <button
                ...
                style={selectedType === type ? { background: "#2ecc71", fontFamily: "'Sora', sans-serif" } : { fontFamily: "'Sora', sans-serif" }}
              >
                {type}
              </button>
            ))}
            ...
            {filteredEvents.map((event) => {
              ...
              return (
                <div
                  ...
                  onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(46,204,113,0.4)"; }}
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <a
                      ...
                      style={{ fontFamily: "'Sora', sans-serif", fontSize: "0.95rem", background: "#2ecc71", color: "white", textDecoration: "none" }}
                      onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.background = "#0f766e"; }}
                      onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.background = "#2ecc71"; }}
                    >
                      Register Now
                    </a>
                  </div>
