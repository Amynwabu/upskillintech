...
const modules = [
  { num: 1, icon: Target, color: "#2E7B20", title: "Find Your Profitable Idea", desc: "Use AI to discover business ideas based on real pain points, market demand & opportunities." },
  { num: 2, icon: UserSearch, color: "#3E9430", title: "Understand Your Audience", desc: "Identify your ideal customers, their problems, needs and what they really want." },
  ...
  { num: 6, icon: CalendarCheck, color: "#2E7B20", title: "Create 30 Days of Content", desc: "Get a full month of content ideas, captions, posts, emails & more in minutes." },
  ...
  { num: 9, icon: Bot, color: "#2E7B20", title: "Automate & Schedule Content", desc: "Automate content creation, posting, follow-ups and lead management." },
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <main className="flex-1 pt-[72px]">
        ...
        >
          <div className="absolute top-[-160px] right-[-120px] rounded-full pointer-events-none" style={{ width: 420, height: 420, background: "rgba(46,123,32,0.08)" }} />
          <div className="absolute bottom-[-140px] left-[-120px] rounded-full pointer-events-none" style={{ width: 360, height: 360, background: "rgba(209,168,29,0.14)" }} />

          <div className="container relative z-10 py-16 lg:py-24">
            <div className="max-w-3xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6" style={{ background: "rgba(46,123,32,0.10)", border: "1px solid rgba(46,123,32,0.20)" }}>
                <Sparkles size={16} style={{ color: "#2E7B20" }} />
                <span style={{ fontFamily: "'Sora', sans-serif", fontSize: "0.85rem", fontWeight: 700, color: "#2E7B20" }}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <ReserveSeatButton
                  ...
                  style={{ fontSize: "1.05rem", padding: "1rem 2.25rem", background: "#2E7B20", boxShadow: "0 4px 14px rgba(46,123,32,0.25)" }}
                />
                <a href="mailto:hello@upskillintech.com" className="btn-outline justify-center" style={{ fontSize: "1.05rem", padding: "1rem 2.25rem", borderColor: "#2E7B20", color: "#2E7B20" }}>
                  Ask a Question
                </a>
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-4 mt-10">
                <div className="rounded-2xl px-6 py-4 text-center" style={{ background: "rgba(255,255,255,0.9)", boxShadow: "0 10px 28px rgba(0,0,0,0.08)" }}>
                  <div style={{ fontFamily: "'Sora', sans-serif", fontWeight: 800, fontSize: "1.5rem", color: "#2E7B20" }}>₦50,000</div>
                  <div style={{ fontSize: "0.85rem", color: "#9CA3AF" }}>Nigeria</div>
                </div>
                <div className="rounded-2xl px-6 py-4 text-center" style={{ background: "rgba(255,255,255,0.9)", boxShadow: "0 10px 28px rgba(0,0,0,0.08)" }}>
                  <div style={{ fontFamily: "'Sora', sans-serif", fontWeight: 800, fontSize: "1.5rem", color: "#2E7B20" }}>£50</div>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "2rem 4rem", alignItems: "center" }}>
              {[
                ...
                <div key={s.label} style={{ textAlign: "center" }}>
                  <div style={{ fontFamily: "'Sora', sans-serif", fontWeight: 800, fontSize: "clamp(1.6rem, 3vw, 2rem)", color: "#2E7B20", lineHeight: 1.1 }}>{s.num}</div>
        ...
        <section className="section-py" style={{ background: "#151B23" }}>
          <div className="container">
            <div className="max-w-4xl mx-auto">
              <div className="rounded-2xl overflow-hidden" style={{ border: "2px solid #2E7B20", boxShadow: "0 12px 40px rgba(46,123,32,0.12)" }}>
                <div style={{ background: "#2E7B20", padding: "1rem 1.5rem", display: "flex", alignItems: "center", gap: "0.75rem" }}>
                    ...
                    <div>
                      ...
                      <a
                        ...
                        style={{
                          ...
                          background: "#2E7B20", color: "#ffffff", borderRadius: "0.75rem",
                    ...
                    <ul style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
                      {[
                        ...
                        <li key={item} style={{ display: "flex", alignItems: "flex-start", gap: "0.75rem" }}>
                          <CheckCircle2 size={17} style={{ color: "#2E7B20", flexShrink: 0, marginTop: "2px" }} />
          ...
          <div className="container max-w-4xl mx-auto text-center">
            ...
            <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "1rem" }}>
              {audience.map((a) => {
                const Icon = a.icon;
                return (
                  <div key={a.label} style={{ display: "flex", alignItems: "center", gap: "0.5rem", background: "rgba(46,123,32,0.07)", borderRadius: "0.75rem", padding: "0.625rem 1.25rem" }}>
                    <Icon size={16} style={{ color: "#2E7B20" }} />
                    <span style={{ fontFamily: "'Sora', sans-serif", fontWeight: 600, fontSize: "0.875rem", color: "#2E7B20" }}>{a.label}</span>
                  </div>
                );
              })}
            </div>
        ...
        <section className="section-py" style={{ background: "#151B23" }}>
          <div className="container">
            <div className="text-center max-w-2xl mx-auto mb-14">
              <span className="section-label" style={{ color: "#2E7B20", background: "rgba(46,123,32,0.10)", borderColor: "rgba(46,123,32,0.20)" }}>The Curriculum</span>
        ...
        <section className="section-py" style={{ background: "#151B23" }}>
          <div className="container">
            <div className="grid lg:grid-cols-[1.1fr_1.1fr_1fr] gap-6 items-stretch">
              ...
              <div className="rounded-2xl p-7" style={{ background: "#151B23", border: "1px solid #1F2937" }}>
                <span className="section-label mb-4 inline-block" style={{ color: "#3E9430", background: "rgba(22,163,74,0.10)", borderColor: "rgba(22,163,74,0.20)" }}>No Tech Skills? No Problem!</span>
                    ...
                    return (
                      <div key={r.title} className="flex items-start gap-3">
                        <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0" style={{ background: "rgba(22,163,74,0.10)" }}>
                          <Icon size={18} style={{ color: "#3E9430" }} />
                        </div>
                        <div>
              ...
              <div className="rounded-2xl p-7 flex flex-col" style={{ background: "#111827", border: "1px solid rgba(255,255,255,0.08)" }}>
                <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-5" style={{ background: "rgba(209,168,29,0.18)" }}>
                  <Gift size={22} style={{ color: "#D1A81D" }} />
                </div>
                ...
                <div className="flex items-center gap-2" style={{ color: "#D1A81D" }}>
        ...
        {/* ── Final CTA ────────────────────────────────────────────────── */}
        <section className="section-py" style={{ background: "linear-gradient(135deg, #2E7B20 0%, #3E9430 100%)" }}>
          <div className="container max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mb-4">
              <ReserveSeatButton
                ...
                style={{ background: "#151B23", color: "#2E7B20", fontFamily: "'Sora', sans-serif" }}
              />
              <a
