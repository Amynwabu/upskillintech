  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <main className="flex-1 pt-[72px]">
        ...
        {/* ── Hero ── */}
        <section style={{ background: "linear-gradient(135deg, #F4F7EA 0%, #F4F7EA 60%, #F4F7EA 100%)", padding: "80px 0 60px" }}>
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#subscribe"
                  ...
                  style={{ background: "linear-gradient(135deg, #859D30, #859D30)", fontSize: "1.05rem" }}>
                ...
                <a href="#latest"
                  ...
                  style={{ border: "2px solid #859D30", color: "#859D30", background: "#07100B", fontSize: "1.05rem" }}>
        ...
        {/* ── What You'll Receive ── */}
        <section style={{ background: "#07100B", padding: "80px 0" }}>
          <div className="container">
            <div className="text-center mb-14">
              <span className="inline-block px-4 py-1.5 rounded-full text-sm font-semibold mb-4"
                style={{ background: "rgba(133, 157, 48,0.1)", color: "#859D30" }}>What's Inside</span>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {BENEFITS.map((b) => {
                const Icon = b.icon;
                return (
                  <div key={b.title} className="surface-light rounded-2xl p-7 transition-all duration-200 hover:-translate-y-1"
                    style={{ border: "1.5px solid #DCE4E6", background: "#FAFAFA" }}>
                    <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4"
                      style={{ background: "rgba(133, 157, 48,0.12)" }}>
                      <Icon size={22} style={{ color: "#859D30" }} />
                    </div>
        ...
        {/* ── Latest Edition ── */}
        <section id="latest" style={{ background: "#07100B", padding: "80px 0" }}>
          <div className="container">
            <div className="text-center mb-12">
              <span className="inline-block px-4 py-1.5 rounded-full text-sm font-semibold mb-4"
                style={{ background: "rgba(133, 157, 48,0.1)", color: "#859D30" }}>Latest Edition</span>
            ...
            <div className="max-w-3xl mx-auto rounded-3xl overflow-hidden shadow-lg"
              style={{ border: "1.5px solid #1F2937", background: "#07100B" }}>
              <div className="p-2" style={{ background: "linear-gradient(135deg, #859D30, #859D30)" }}>
          ...
          <div className="container">
            <div className="flex items-center justify-between mb-12">
              <div>
                <span className="inline-block px-4 py-1.5 rounded-full text-sm font-semibold mb-3"
                  style={{ background: "rgba(133, 157, 48,0.1)", color: "#859D30" }}>Past Editions</span>
              ...
              <Link href="/newsletter/archive"
                ...
                style={{ border: "1.5px solid #859D30", color: "#859D30", background: "#07100B", fontSize: "0.95rem" }}>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {EDITIONS.slice(1).map((ed) => (
                <Link key={ed.slug} href={`/newsletter/${ed.slug}`}
                  className="surface-light block rounded-2xl p-7 transition-all duration-200 hover:-translate-y-1 hover:shadow-md cursor-pointer"
                  style={{ border: "1.5px solid #DCE4E6", background: "#FAFAFA" }}>
                  <div className="inline-block px-3 py-1 rounded-full text-xs font-bold mb-4"
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4" style={{ color: "#4B5563", fontSize: "0.85rem" }}>
                    ...
                    <span className="flex items-center gap-1 font-semibold text-sm" style={{ color: "#859D30" }}>
            ...
            <div className="text-center mt-10">
              <Link href="/newsletter/archive"
                ...
                style={{ border: "1.5px solid #859D30", color: "#859D30", background: "#07100B" }}>
        ...
        {/* ── Subscribe Section ── */}
        <section id="subscribe" style={{ background: "linear-gradient(135deg, #111827 0%, #07100B 100%)", padding: "80px 0" }}>
          <div className="container">
            <div className="max-w-2xl mx-auto text-center">
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6"
                style={{ background: "rgba(133, 157, 48,0.2)" }}>
                <Mail size={28} style={{ color: "#859D30" }} />
              </div>
              ...
              {submitted ? (
                <div className="rounded-2xl p-10 text-center" style={{ background: "rgba(133, 157, 48,0.15)", border: "1.5px solid rgba(133, 157, 48,0.3)" }}>
                  <CheckCircle size={48} className="mx-auto mb-4" style={{ color: "#859D30" }} />
