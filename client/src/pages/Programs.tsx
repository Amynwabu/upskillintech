 ...
 * Design: Green (#859D30) + Golden Green (#859D30) + Accent Yellow (#859D30)
...
export default function Programs() {
  ...
  return (
    <div className="min-h-screen bg-[#07100B] font-inter">
      <Navbar />
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 w-64 h-64 rounded-full opacity-10"
          style={{ background: "radial-gradient(circle, #859D30 0%, transparent 70%)", transform: "translate(-30%, 30%)" }} />
        ...
        <div className="max-w-4xl mx-auto px-4 lg:px-8 text-center text-[#F3F4F6] relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="#programmes"
              ...
              style={{ background: "#859D30", color: "#F3F4F6" }}
              onMouseEnter={e => (e.currentTarget.style.background = "#859D30")}
            ...
            <a href="/contact"
              ...
              onMouseEnter={e => { e.currentTarget.style.background = "#F4F7EA"; e.currentTarget.style.color = "#859D30"; }}
              onMouseLeave={e => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = "#859D30"; }}>
              Talk to Us
            </a>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            {[
              ...
              <div key={i} className="rounded-xl px-4 py-3 text-center text-[#F3F4F6]"
                style={{ background: "rgba(133, 157, 48,0.10)" }}>
                <p className="font-poppins font-bold text-xl" style={{ color: "#859D30" }}>{stat.value}</p>
            ...
            {programs.map((prog) => {
              ...
              return (
                <div key={prog.id}
                  ...
                  style={{
                    borderColor: isExpanded ? prog.color : "#1F2937",
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2 mb-1">
                        <h3 className="font-poppins font-bold text-lg" style={{ color: "#F3F4F6" }}>{prog.title}</h3>
                      ...
                      <p className="text-sm leading-relaxed" style={{ color: "#9CA3AF" }}>{prog.description}</p>
                  ...
                  {isExpanded && (
                    <div className="px-6 pb-6 border-t" style={{ borderColor: `${prog.color}20` }}>
                      <div className="grid md:grid-cols-2 gap-8 pt-6">
                        {/* Outcomes */}
                        <div>
                          <h4 className="font-poppins font-semibold text-sm mb-4 flex items-center gap-2" style={{ color: "#F3F4F6" }}>
                          ...
                          <div className="space-y-3">
                            {prog.modules.map((mod, i) => (
                              <div key={i} className="flex gap-3">
                                ...
                                <div>
                                  <p className="text-sm font-semibold" style={{ color: "#F3F4F6" }}>{mod.title}</p>
                                  <p className="text-xs mt-0.5" style={{ color: "#9CA3AF" }}>{mod.desc}</p>
                                </div>
                              </div>
                            ))}
                          </div>
      ...
      <section className="section-py" style={{ background: "#07100B" }}>
        <div className="max-w-5xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <span className="text-xs font-semibold uppercase tracking-widest px-3 py-1 rounded-full mb-4 inline-block"
              style={{ background: "#07100B", color: "#859D30" }}>How It Works</span>
            <h2 className="font-poppins font-bold text-4xl lg:text-5xl mb-4" style={{ color: "#F3F4F6" }}>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { step: "01", icon: Target, title: "Choose Your Programme", desc: "Select the programme that matches your current level and goals.", color: "#859D30" },
              { step: "02", icon: BookOpen, title: "Learn at Your Pace", desc: "Work through structured modules with videos, exercises, and resources.", color: "#859D30" },
              { step: "03", icon: Zap, title: "Apply in Real Work", desc: "Implement what you learn directly in your daily workflows and tasks.", color: "#859D30" },
              { step: "04", icon: Award, title: "Get Certified", desc: "Complete the programme and receive your UpskillinTech certificate.", color: "#859D30" },
            ].map((item, i) => {
              ...
              return (
                <div key={i} className="text-center">
                  ...
                  <h3 className="font-poppins font-semibold text-base mb-2" style={{ color: "#F3F4F6" }}>{item.title}</h3>
      ...
      <section className="section-py" style={{ background: "#1C1C1C" }}>
        <div className="max-w-5xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <span className="text-xs font-semibold uppercase tracking-widest px-3 py-1 rounded-full mb-4 inline-block"
              style={{ background: "rgba(133, 157, 48,0.2)", color: "#859D30" }}>What Professionals Say</span>
              ...
              <div key={i} className="rounded-2xl p-6" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)" }}>
                <div className="flex gap-0.5 mb-4">
                  {Array.from({ length: t.rating }).map((_, j) => (
                    <Star key={j} size={14} fill="#859D30" style={{ color: "#859D30" }} />
                  ))}
                </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full flex items-center justify-center font-bold text-sm text-white"
                    style={{ background: "linear-gradient(135deg, #859D30, #859D30)" }}>
      ...
      {/* ── FAQ ──────────────────────────────────────────────────────────── */}
      <section className="py-20 bg-[#07100B]">
        <div className="max-w-3xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <span className="text-xs font-semibold uppercase tracking-widest px-3 py-1 rounded-full mb-4 inline-block"
              style={{ background: "#07100B", color: "#859D30" }}>FAQ</span>
            <h2 className="font-poppins font-bold text-4xl lg:text-5xl mb-4" style={{ color: "#F3F4F6" }}>
          ...
          <div className="space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="rounded-xl border overflow-hidden transition-all"
                style={{ borderColor: openFaq === i ? "#859D30" : "#1F2937" }}>
                <button
                ...
                >
                  ...
                  {openFaq === i
                    ? <ChevronUp size={16} style={{ color: "#859D30", flexShrink: 0 }} />
      ...
      <section className="section-py"
        style={{ background: "linear-gradient(135deg, #859D30 0%, #859D30 60%, #859D30 100%)" }}>
        <div className="max-w-3xl mx-auto px-4 text-center text-white">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href="/enterprise"
              ...
              onMouseEnter={e => { e.currentTarget.style.background = "#fff"; e.currentTarget.style.color = "#859D30"; }}
