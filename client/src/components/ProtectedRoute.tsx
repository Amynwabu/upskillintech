...
export default function ProtectedRoute({ children }: ProtectedRouteProps) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#F7F8FA] pt-[76px]">
        <Navbar />
        <main className="container flex min-h-[calc(100vh-76px)] items-center justify-center">
  ...
  if (!user) {
    return (
      <div className="flex min-h-screen flex-col bg-[#F7F8FA]">
        <Navbar />
        <main className="container flex flex-1 items-center justify-center pt-[76px]">
