...
export default function EnterpriseSection() {
  return (
    <section id="enterprise" className="section-py" style={{ background: "#07100B" }}>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="mt-4 mb-5">
              AI Transformation for <span style={{ color: "#859D30" }}>Organisations</span>
            </h2>
            ...
            <ul className="flex flex-col gap-5 mb-10">
              {benefits.map((b) => (
                <li key={b.title} className="flex items-start gap-4">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5" style={{ background: "rgba(133, 157, 48,0.12)" }}>
          ...
          <div className="flex justify-center lg:justify-end">
            ...
            >
              ...
              >
                <div style={{ fontFamily: "'Sora', sans-serif", fontSize: "1.6rem", fontWeight: 800, color: "#859D30" }}>50+</div>
