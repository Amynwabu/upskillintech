      ...
      <div className="container">
        ...
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto" style={{ fontSize: "1.15rem", color: "#9CA3AF" }}>
            ...
            <span style={{ color: "#859D30", fontWeight: 700 }}>We help you integrate AI into real work.</span>
          </p>
        </div>
            ...
            <div key={step.label} className="flex items-start">
              <div className="flex flex-col items-center" style={{ width: 240 }}>
                ...
                <div className="text-center px-4">
                  <div
                    ...
                    style={{ fontFamily: "'Sora', sans-serif", color: "#F3F4F6", fontSize: "1.1rem" }}
                  >
                    {step.label}
                  </div>
                  <div style={{ fontSize: "0.9rem", lineHeight: 1.65, color: "#9CA3AF" }}>
                    {step.desc}
                  </div>
                </div>
              </div>
              ...
              {i < steps.length - 1 && (
                <div
                  ...
                  style={{ color: "#859D30", fontSize: "2rem", fontWeight: 800 }}
                >
                  →
                </div>
              )}
          ...
          {steps.map((step, i) => (
            <div key={step.label} className="flex gap-5">
              <div className="flex flex-col items-center">
                ...
                {i < steps.length - 1 && (
                  <div style={{ width: 3, flex: 1, background: "linear-gradient(to bottom, #859D30, #859D30)", minHeight: 40, margin: "6px 0", borderRadius: 2 }} />
                )}
              </div>
              <div className="pb-10">
                <div
                  className="font-bold mb-2"
                  style={{ fontFamily: "'Sora', sans-serif", color: "#F3F4F6", fontSize: "1.15rem" }}
                >
                  {step.label}
                </div>
                <div style={{ fontSize: "0.975rem", lineHeight: 1.7, color: "#9CA3AF" }}>
                  {step.desc}
                </div>
              </div>
            </div>
