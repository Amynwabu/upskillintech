  ...
  return (
    <section style={{ background: "#F3F1EE", padding: "4rem 0" }}>
      <div className="container">
        <div
          style={{
            background: "linear-gradient(135deg, #859D30 0%, #859D30 100%)",
            borderRadius: "1.5rem",
            padding: "3rem 2.5rem",
            display: "grid",
            gap: "2.5rem",
        ...
        >
          ...
          <div style={{ position: "absolute", bottom: "-40px", left: "-40px", width: 180, height: 180, borderRadius: "50%", background: "rgba(133, 157, 48,0.12)", pointerEvents: "none" }} />
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "0.875rem" }}>
              <a
                ...
                style={{
                  ...
                  background: "#07100B", color: "#859D30", borderRadius: "0.75rem",
          ...
          <div style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <div style={{ background: "rgba(133, 157, 48,0.15)", border: "1px solid rgba(133, 157, 48,0.35)", borderRadius: "1rem", padding: "1rem 1.5rem", display: "flex", alignItems: "center", gap: "0.75rem" }}>
              <Gift size={18} style={{ color: "#859D30", flexShrink: 0 }} />
